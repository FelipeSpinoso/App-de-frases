...
<SafeAreaView style={styles.Principal}>
 <Text style={styles.Titulo}><FontAwesome name="comment-o" size={40}></FontAwesome>  Fala Verissimo</Text>
 <Image source={verissimo} style={styles.Image} />
 {/*Sou um comentario*/}
 ...
 <View style={styles.ViewBotao}>  
    <FontAwesome.Button
      ...
      onPress={falar}// cria uma função para o botão
      style={styles.Botao}>
          Ouvir a frase
    </FontAwesome.Button>
    <FontAwesome.Button
       name="stop-circle"
      backgroundColor={!falando ? "#CCCC":"#D9534b"}
      disabled={!falando}
      onPress={parar}// cria uma função para o botão
      style={styles.Botao}>
        Parar
       </FontAwesome.Button>
        </View>  
